...
export default function MobileNav({ activeView, onViewChange }: MobileNavProps) {
  return (
    <nav className="md:hidden fixed bottom-20 left-4 right-4 h-20 bg-spotify-black/80 backdrop-blur-3xl border border-white/5 flex items-center justify-around px-6 z-50 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      <motion.button 
        whileTap={{ scale: 0.8 }} 
