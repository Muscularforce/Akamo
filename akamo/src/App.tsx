...
export default function App() {
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'library':
        return <LibraryView tracks={filteredTracks} onPlay={handlePlay} onUploadClick={() => setIsUploadModalOpen(true)} />;
      case 'favorites':
        return <LibraryView tracks={filteredTracks.slice(0, 3)} onPlay={handlePlay} onUploadClick={() => setIsUploadModalOpen(true)} />;
      default:
        return (
          <motion.div
  ...
  return (
    <div 
      className="flex h-screen bg-spotify-black overflow-hidden relative selection:bg-spotify-green selection:text-black"
      data-theme={theme}
    >
      ...
      <main className="flex-1 flex flex-col relative z-10 overflow-y-auto no-scrollbar">
        ...
        <div className="h-40" /> {/* Spacer for player */}
      </main>
